...
public class LinkedList : IEnumerable<int>
{
    ...
    public void InsertTail(int value)
    {
        ...
        {
            _tail.Next = newNode; // Connecting the previous tail to the new node
            newNode.Prev = _tail; // Connecting the new node to the previous tail
            _tail = newNode; // Updating the tail to point to the new node
        }
    }
    ...
    public void RemoveTail()
    {
        ...
        {
            _tail.Prev!.Next = null; // Disconnecting the second-to-last node from the last node
            _tail = _tail.Prev; // Updating the tail to point to the second-to-last node
        }
    }
    ...
    public void Replace(int oldValue, int newValue)
    {
        ...
        while (curr is not null)
        {
            ...
            curr = curr.Next; // Continue to next node (don't return)
        }
    }
